...
# it initializes a new global $initializers hash, and registers a
# BeanPostProcessor with the [ new ] $bean_factory to run the initializers

# EVIL springy context parsing is NOT THREAD SAFE since it uses a global BeanFactory and initialiser hash
